...
namespace Codify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819090251_AddInstructorStudentsAndContestInvitations")]
    partial class AddInstructorStudentsAndContestInvitations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codify.Domain.Entities.InstructorStudent", b =>
                {
            ...
            modelBuilder.Entity("Codify.Domain.Entities.Problem", b =>
                {
                    ...
                    b.Property<int>("AcceptedSubmissionsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("TotalSubmissionsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Codify.Domain.Entities.InstructorStudent", b =>
                {
                    b.HasOne("Codify.Domain.Entities.User", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("Codify.Domain.Entities.Problem", b =>
                {
                    b.HasOne("Codify.Domain.Entities.User", "Author")
